...
def bbox_iou(box1, box2, xywh=True, GIoU=False, DIoU=False, CIoU=False, VIoU=False, eps=1e-7):
    """
    ...
    # IoU
    iou = inter / union
    if VIoU or CIoU or DIoU or GIoU:
        cw = b1_x2.maximum(b2_x2) - b1_x1.minimum(b2_x1)  # convex (smallest enclosing box) width
        ch = b1_y2.maximum(b2_y2) - b1_y1.minimum(b2_y1)  # convex height
        if VIoU or CIoU or DIoU:  # Distance or Complete IoU https://arxiv.org/abs/1911.08287v1
...
def probiou(obb1, obb2, CIoU=False, VIoU=False, eps=1e-7):
    """
